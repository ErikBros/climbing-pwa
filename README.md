...
- **Weekly plan** — plans are per calendar week (ISO-week keyed), not a recurring template: plan this week, flip to next week to plan ahead, and when a fresh week starts it's blank with a one-tap "Copy last week's plan". Past days dim; the Train picker pre-fills from today's entry in this week's plan (deviations on the day are free and never write back). Old weeks are pruned after ~8 weeks.
